...
export const ACCEPTANCE_CASES = Object.freeze([
  ...
  waitingStatusPair({ id: "b3-status-waiting-plot", title: "Plot availability", control: "Check plot availability", waiting: "Checking plot availability, please wait.", task: "Check plot availability and notice whether anything is announced while it works." }),
  ...
  progressStatusPair({ id: "b3-status-progress-plot", title: "Growing plot application", control: "Continue to plot choice", progress: "Step 2 of 3", task: "Continue to plot choice and notice whether the step change is announced." }),
  ...
  statusPair({ id: "b3-status-plot", title: "Growing plots", control: "Show vacant plots", task: "Show vacant plots and notice the result count." }),
